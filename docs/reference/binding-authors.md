...
| Pre-sync ingress ceiling (`DemuxerConfig::sync_buf_cap`) | ✅ | ✅ `tst_demux_config_set_sync_buf_cap` (ABI 0.22; 0 = default) | ✅ `DemuxerConfig.sync_buf_cap` | ✅ `DemuxerConfig.Builder.syncBufCap(long)` (0 = default) |
