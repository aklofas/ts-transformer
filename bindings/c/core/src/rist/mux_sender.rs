...
//! The non-freeing cross-thread cancel is `tst_rist_mux_sender_cancel`, a
//! new symbol that rides the ABI 0.22 bump (see "C ABI cancel entry points
//! for `tcp://`, `udp://` and `rist://` transports" in
